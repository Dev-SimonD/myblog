  ...
  return (
    <div className='container iconBar'>
        <div className="d-flex flex-column align-items-center">
            <Image src={Vyvoj} className="image" style={{"width":"100px"}}fluid="true"/>
            <p className='iconText'>Vývoj</p>
        </div>
        <div className="d-flex flex-column align-items-center">
        <Image src={Marketing} className="image" style={{"width":"100px"}}fluid="true"/>
            <p className='iconText'>Marketing a obchod</p>
        </div>
        <div className="d-flex flex-column align-items-center">
        <Image src={Analytika} className="image" style={{"width":"100px"}}fluid="true"/>
            <p className='iconText'>Analytika</p>
        </div>
        <div className="d-flex flex-column align-items-center">
        <Image src={Managment} className="image" style={{"width":"100px"}}fluid="true"/>
            <p className='iconText'>Managment</p>
        </div>
        <div className="d-flex flex-column align-items-center">
        <Image src={Administrativa} className="image" style={{"width":"100px"}} fluid="true"/>
            <p className='iconText'>Administrativa a jiné</p>
        </div>
        <div className="d-flex flex-column align-items-center" id="spoluzakladatel">
        <Image src={Spoluzakladatel} className="image" style={{"width":"100px"}}fluid="true"/>
